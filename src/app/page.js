  ...
  return (
    <>
     ...
     <div className="mt-8 flex justify-center font-medium">
      <a className=" w-[300px] flex justify-center items-center text-2xl text-gray-500 border border-gray-300 rounded-xl px-6 py-2" href="tel:+355691234123">
    ...
    <div className="mt-8 flex justify-center font-medium">
      <a className=" w-[300px] flex justify-center items-center text-2xl text-white  bg-green-500 border border-gray-300 rounded-xl px-6 py-2" aria-label="Chat on WhatsApp" href="https://wa.me/355691234123">
